...
<body>
  ...
  <ul>
      <li><a href="slogin1.php">Student Login</a></li>
                ...
                <div class="panel-body">
                  <form name="form1" id="contactform" method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="padding-top-10 col-md-4">
                      ...
                      <input type="text" name="f_name" class="form-control" id="firstName" placeholder="Enter your first name" onBlur="allLetter(document.form1.txtFname)" />
                    </div>
                    <div class="col-md-4 padding-top-10">
                      <label for="lastName" name="l_name" class="control-label">Last Name :</label>
                    ...
                    <div class="col-md-5 padding-top-10">
                      ...
                      <input type="text" name="user_mob" maxlength="10" class="form-control" id="mobile" placeholder="Enter your mobile number" onBlur="allNumber(document.form1.txtMobile)" />
                    </div>
...
<?php
  ...
  $sql = "INSERT INTO sregistration (firstname,lastname,dateofbirth,gender,department,rollno,email,password,registrationno,programme,tenp,twelvep,sem,mob,address,username,activate) VALUES ('$fname', '$lname' , '$b_day','$gender' ,'$branch','$roll_no','$email','$password','$r_no','$prog','$tenp','$twelvep','$sem','$mob','$add','$user_name',0 )";
  }

  if (isset($_POST['submitted']) == 1) {
  if(mysqli_query($link, $sql)){
  $message = "Please wait while account is verified by admin.";
